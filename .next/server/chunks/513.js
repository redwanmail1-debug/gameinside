exports.id=513,exports.ids=[513],exports.modules={5895:(e,n,a)=>{Promise.resolve().then(a.t.bind(a,2481,23)),Promise.resolve().then(a.t.bind(a,9404,23))},3652:(e,n,a)=>{"use strict";a.d(n,{Z:()=>s});var t=a(9510),i=a(7371),r=a(7710),o=a(9857);function s({article:e,size:n="default"}){let a=o.wE[e.category]??"bg-blue-500",s=o.eR[e.category]??"text-blue-400";return t.jsx(i.default,{href:`/artikel/${e.slug}`,className:"group block h-full",children:(0,t.jsxs)("article",{className:"gi-card h-full flex flex-col relative",children:[t.jsx("div",{className:`absolute left-0 top-0 bottom-0 w-0.5 rounded-l-xl ${a} opacity-70`}),(0,t.jsxs)("div",{className:`relative ${"large"===n?"h-56 md:h-72":"small"===n?"h-36":"h-48"} overflow-hidden flex-shrink-0`,children:[t.jsx(r.default,{src:e.image,alt:e.title,fill:!0,className:"object-cover transition-transform duration-400 group-hover:scale-[1.04]",sizes:"(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"}),t.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-[#0d1117]/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"}),(0,t.jsxs)("div",{className:"absolute top-2.5 left-2.5 flex gap-1.5 flex-wrap",children:[e.isBreaking&&t.jsx("span",{className:"px-2 py-0.5 text-xs font-black uppercase tracking-wider rounded-md bg-red-600 text-white shadow-lg",children:"Breaking"}),t.jsx("span",{className:`px-2 py-0.5 text-xs font-bold uppercase tracking-wider rounded-md text-white shadow-lg ${a}`,children:e.categoryLabel})]})]}),(0,t.jsxs)("div",{className:"p-4 flex flex-col flex-1",children:[t.jsx("h2",{className:`font-bold text-white group-hover:text-[#00aaff] transition-colors leading-snug mb-2 ${"large"===n?"text-xl md:text-2xl":"small"===n?"text-sm":"text-base"}`,children:e.title}),"small"!==n&&t.jsx("p",{className:"text-[#8b949e] text-sm line-clamp-2 mb-3 flex-1 leading-relaxed",children:e.excerpt}),e.score&&t.jsx("div",{className:"flex items-center gap-1 mb-2",children:(0,t.jsxs)("span",{className:"px-2 py-0.5 text-xs font-black rounded-md bg-[#7c3aed]/20 border border-[#7c3aed]/40 text-purple-300",children:[e.score,"/10"]})}),(0,t.jsxs)("div",{className:"flex items-center justify-between text-xs text-[#555e6b] mt-auto pt-2 border-t border-[#30363d]/60",children:[t.jsx("span",{className:`font-semibold ${s}`,children:e.author}),t.jsx("span",{className:"text-[#8b949e]",children:new Date(e.date).toLocaleDateString("nl-NL",{day:"numeric",month:"short"})})]})]})]})})}},9050:(e,n,a)=>{"use strict";a.d(n,{Z:()=>s});var t=a(9510),i=a(7371),r=a(9857);let o=["from-[#00aaff] to-[#7c3aed]","from-[#00aaff] to-[#0088cc]","from-[#7c3aed] to-[#5b21b6]","from-[#30363d] to-[#1c2333]","from-[#30363d] to-[#1c2333]"];function s({mostRead:e}){return(0,t.jsxs)("aside",{className:"space-y-5",children:[(0,t.jsxs)("div",{className:"bg-[#1c2333] border border-[#30363d] rounded-xl overflow-hidden",children:[(0,t.jsxs)("div",{className:"px-4 py-3 bg-[#161b22] border-b border-[#30363d] flex items-center gap-2",children:[t.jsx("div",{className:"w-1 h-5 rounded-full bg-gradient-to-b from-[#00aaff] to-[#7c3aed]"}),t.jsx("h3",{className:"text-sm font-black text-white uppercase tracking-wide",children:"Meest gelezen"})]}),t.jsx("div",{className:"divide-y divide-[#30363d]/60",children:e.map((e,n)=>{let a=r.eR[e.category]??"text-blue-400";return(0,t.jsxs)(i.default,{href:`/artikel/${e.slug}`,className:"group flex gap-3 p-3.5 hover:bg-[#161b22]/80 transition-colors",children:[t.jsx("div",{className:`flex-shrink-0 w-7 h-7 rounded-full bg-gradient-to-br ${o[n]}
                                 flex items-center justify-center shadow-lg`,children:t.jsx("span",{className:"text-xs font-black text-white",children:n+1})}),(0,t.jsxs)("div",{className:"flex-1 min-w-0",children:[t.jsx("h4",{className:"text-xs font-semibold text-[#e6edf3] group-hover:text-[#00aaff] transition-colors line-clamp-2 leading-snug mb-0.5",children:e.title}),(0,t.jsxs)("p",{className:`text-xs font-medium ${a}`,children:[e.views.toLocaleString("nl-NL")," views"]})]})]},e.id)})})]}),(0,t.jsxs)("div",{className:"bg-[#1c2333] border border-[#30363d] rounded-xl overflow-hidden",children:[(0,t.jsxs)("div",{className:"px-4 py-3 bg-[#161b22] border-b border-[#30363d] flex items-center gap-2",children:[t.jsx("div",{className:"w-1 h-5 rounded-full bg-gradient-to-b from-[#7c3aed] to-[#00aaff]"}),t.jsx("h3",{className:"text-sm font-black text-white uppercase tracking-wide",children:"Categorie\xebn"})]}),t.jsx("div",{className:"p-3.5 flex flex-wrap gap-2",children:Object.keys(r.EE).map(e=>t.jsx(i.default,{href:`/categorie/${e}`,className:"px-3 py-1.5 text-xs font-bold uppercase tracking-wider rounded-lg border border-[#30363d] text-[#8b949e] hover:border-[#00aaff]/60 hover:text-[#00aaff] hover:bg-[#00aaff]/5 transition-all",children:r.EE[e]},e))})]}),(0,t.jsxs)("div",{className:"rounded-xl p-5 bg-gradient-to-br from-[#00aaff]/10 to-[#7c3aed]/10 border border-[#00aaff]/20",children:[(0,t.jsxs)("div",{className:"flex items-center gap-2 mb-1",children:[t.jsx("div",{className:"w-5 h-5 rounded-full bg-gradient-to-r from-[#00aaff] to-[#7c3aed] flex items-center justify-center flex-shrink-0",children:(0,t.jsxs)("svg",{className:"w-2.5 h-2.5 text-white",fill:"currentColor",viewBox:"0 0 20 20",children:[t.jsx("path",{d:"M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"}),t.jsx("path",{d:"M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"})]})}),t.jsx("h3",{className:"text-sm font-black text-white uppercase tracking-wide",children:"Newsletter"})]}),t.jsx("p",{className:"text-xs text-[#8b949e] mb-3 leading-relaxed",children:"Het beste gaming nieuws dagelijks in je inbox."}),t.jsx("input",{type:"email",placeholder:"jouw@email.nl",className:"w-full bg-[#0d1117] border border-[#30363d] rounded-lg px-3 py-2 text-sm text-white placeholder-[#555e6b] focus:outline-none focus:border-[#00aaff] focus:shadow-[0_0_0_3px_rgba(0,170,255,0.1)] transition-all mb-2"}),t.jsx("button",{className:"w-full rounded-lg py-2 text-xs font-black uppercase tracking-wider text-white bg-gradient-to-r from-[#00aaff] to-[#7c3aed] hover:from-[#0088cc] hover:to-[#6d28d9] transition-all shadow-[0_0_16px_rgba(0,170,255,0.2)] hover:shadow-[0_0_24px_rgba(0,170,255,0.35)]",children:"Inschrijven"})]})]})}},9857:(e,n,a)=>{"use strict";a.d(n,{Dq:()=>t,EE:()=>l,Wr:()=>s,Zd:()=>o,eA:()=>d,eR:()=>m,uL:()=>i,vX:()=>r,wE:()=>g});let t=[{id:1,slug:"resident-evil-requiem-launch-day-review",title:"Resident Evil Requiem is er — en het is angstaanjagend goed",excerpt:"Capcom lanceert vandaag Resident Evil Requiem, de negende hoofddeel in de legendarische survivalhorrorserie. Met FBI-agente Grace Ashcroft als nieuw gezicht en Leon Kennedy die terugkeert naar Raccoon City, belooft dit de meest ambitieuze RE ooit te worden. Gameinside speelde twaalf uur en is onder de indruk.",content:`Het is zover. Na bijna negen maanden wachten — van de eerste aankondiging op Summer Game Fest tot de dramatische vierde trailer tijdens de State of Play van twee weken geleden — is Resident Evil Requiem eindelijk speelbaar. En wij hebben twaalf uur lang bijna niet durven ademhalen.
...
Resident Evil Requiem is veelbelovend op een manier die we al jaren niet meer hebben gevoeld bij een grote release. Capcom levert. Onze volledige review verschijnt over het weekend wanneer we het spel hebben uitgespeeld — maar als de tweede helft bijhoudt wat de eerste belooft, kijken we naar een sterke kandidaat voor Game of the Year 2026.`,category:"games",categoryLabel:"Games",author:"Thomas van der Berg",date:"2026-02-27",image:"https://cdn.akamai.steamstatic.com/steam/apps/3764200/header.jpg",isFeatured:!0,isBreaking:!0,views:52840,readTime:6},{id:2,slug:"phil-spencer-verlaat-microsoft-asha-sharma-nieuwe-xbox-baas",title:"Phil Spencer verlaat Microsoft na 38 jaar — Asha Sharma neemt het roer over",excerpt:"In een verrassende zet heeft Phil Spencer aangekondigd dat hij na 38 jaar Microsoft verlaat. Sarah Bond, president van Xbox, vertrekt ook. De nieuwe baas is Asha Sharma, tot nu toe hoofd van Microsoft's CoreAI-divisie. Wat betekent dit voor Xbox, Game Pass en de Nederlandse gamers?",content:`Het nieuws sloeg in als een bom. Op donderdag 20 februari maakte Phil Spencer via een persoonlijk bericht op Xbox Wire bekend dat hij Microsoft verlaat. Na 38 jaar bij het bedrijf, waarvan de laatste jaren als CEO van Microsoft Gaming, gaat hij met pensioen. Tegelijkertijd kondigt Sarah Bond, de president van Xbox, haar vertrek aan. Het tijdperk-Spencer is voorbij.
...
Spencer verdiende meer lof dan hij vaak kreeg. Zijn vertrek voelt voorbarig en de timing is ongelukkig. We hopen dat Sharma bewijst dat Xbox ook zonder zijn architect zijn identiteit behoudt — maar we zijn eerlijk gezegd zenuwachtig.`,category:"nieuws",categoryLabel:"Nieuws",author:"Sophie Bakker",date:"2026-02-20",image:"https://xboxwire.thesourcemediaassets.com/sites/2/2026/01/201408_Base-Event-Announce_3840x2160_01-d74edda15b45247820b4.jpg",isBreaking:!0,views:39200,readTime:5},{id:3,slug:"nioh-3-review-team-ninja-soulslike",title:"Nioh 3 review — Team Ninja toont opnieuw waarom ze meesters zijn in het genre",excerpt:"Na Nioh 2 leek de lat onmogelijk hoog te liggen. Nioh 3 gooit het over een andere boeg: kies je eigen stijl als Samurai of Ninja, verken uitgestrekte open gebieden en vecht zij aan zij met vrienden in de nieuwe 3-speler co-op. Gameinside besteedde 55 uur aan deze klapper.",content:`Team Ninja heeft ons de afgelopen tien jaar laten zien dat zij het Soulslike-genre op een geheel eigen manier begrijpen. Nioh en Nioh 2 waren keihard, technisch uitdagend en rijker in systemen dan haast elk ander spel in het genre. Nioh 3 is de volgende stap — en het is een groot stap voorwaarts.
...
**Score: 9/10**`,category:"reviews",categoryLabel:"Reviews",author:"Mark Visser",date:"2026-02-15",image:"https://cdn.akamai.steamstatic.com/steam/apps/3681010/header.jpg",views:28650,readTime:7,score:9},{id:4,slug:"god-of-war-sons-of-sparta-alles-wat-we-weten",title:"God of War: Sons of Sparta — shadow drop van het jaar en alles wat we al weten",excerpt:"Sony verraste iedereen met een onaangekondigde release tijdens de State of Play: God of War: Sons of Sparta is nu speelbaar op PS5. Een 2D-actiegame over een jonge Kratos die zijn dochter Calliope een verhaal vertelt. Wat is het, hoe speelt het, en is het de moeite waard?",content:`Sony Santa Monica heeft de gaming-wereld op 12 februari letterlijk overvallen. Midden in de State of Play-presentatie — die al rijkelijk was gevuld met aankondigingen — verscheen een trailer die niemand had zien aankomen: God of War: Sons of Sparta. En het spel was meteen beschikbaar. Geen preorder-periode, geen marketingblitz. Gewoon: kopen en spelen.

**Wat is Sons of Sparta precies?**

Sons of Sparta is geen vervolg op Ragnar\xf6k en geen prequel op de stijl van 2018's God of War. Het is een 2D-actiegame — een bewuste stijlkeuze die verwijst naar het originele God of War (2005) en zijn opvolgers. Het spel is ontwikkeld door Mega Cat Studios in samenwerking met Santa Monica Studio, hetzelfde team dat eerder de uitstekende Wonder Boy-remakes produceerde.
...
**Score: 8.5/10**`,category:"games",categoryLabel:"Games",author:"Thomas van der Berg",date:"2026-02-12",image:"https://blog.playstation.com/tachyon/2026/02/6cce0478459b4f47549fa59e9168f04924295731-scaled.jpg",views:23900,readTime:5,score:8.5},{id:5,slug:"gta-6-releasedatum-19-november-2026-bevestigd",title:"GTA 6 heeft nu een definitieve releasedatum: 19 november 2026",excerpt:"Na twee uitstellingen en maanden van stilte heeft Rockstar Games eindelijk de nieuwe releasedatum bekendgemaakt. Grand Theft Auto VI verschijnt op 19 november 2026 voor PS5 en Xbox Series X|S. Eerste echte gameplay is ook getoond. Wij analyseren alles.",content:`Rockstar Games heeft op 10 februari 2026 via een formeel persbericht en begeleidende 14 minuten durende gameplay-presentatie de nieuwe releasedatum voor Grand Theft Auto VI bekendgemaakt. Die datum is 19 november 2026 — en dit keer klinkt Rockstar een stuk stelliger dan bij de twee eerdere aankondigingen die beide werden ingetrokken.

**De weg hiernaartoe**

Het is geen geheim dat GTA VI een roerige ontwikkeling heeft gehad. De eerste trailer in december 2023 cre\xeberde een golf van hype die moeiteloos YouTube-records verbrak. Maar het spel zou in 2025 verschijnen en werd eerst uitgesteld naar voorjaar 2026, en daarna opnieuw naar november 2026. Rockstar ontsloeg in diezelfde periode 30 medewerkers die intern campagne voerden voor een vakbond — een stap die in de bredere gaming-industrie veel kritiek opleverde.
...
We geloven Rockstar deze keer. De gameplay ziet er compleet uit, de release zit nu in het vierde kwartaal — traditioneel de sterkste periode voor grote releases — en de zakelijke druk is enorm. GTA VI wordt ofwel het beste spel ooit gemaakt, ofwel de grootste teleurstelling in gaming-geschiedenis. Er is geen tussenweg.`,category:"games",categoryLabel:"Games",author:"Thomas van der Berg",date:"2026-02-10",image:"https://img.youtube.com/vi/QdBZY2fkU-0/maxresdefault.jpg",isBreaking:!0,views:47100,readTime:5},{id:6,slug:"nintendo-switch-2-beste-games-2026",title:"Nintendo Switch 2: dit zijn de beste games die nog komen in 2026",excerpt:"Mario Tennis Fever, Hollow Knight: Silksong, Metroid Prime 4 Beyond en meer — het Nintendo Switch 2-jaar is nog maar net begonnen en de line-up ziet er al veelbelovend uit. Gameinside zet alle aankomende releases op een rij en geeft zijn eigen verlanglijst.",content:`De Nintendo Switch 2 is nu vier maanden oud en heeft al bewezen een systeem te zijn dat zowel casual als hardcore gamers in vervoering brengt. Mario Kart World bij launch, Donkey Kong Bananza als verrassende hit — het begin was sterk. Maar wat staat er nog op de planning voor de rest van 2026?
...
Naast de bevestigde games hopen wij op: een nieuw Star Fox-spel (al tien jaar stilte), een verrassende Pok\xe9mon Legends-aankondiging en de lang verwachte Switch 2-versie van Breath of the Wild's opvolger, Tears of the Kingdom. Nintendo houdt de kaarten dicht tegen de borst, maar heeft bewezen dat de Switch 2 een platform is dat de moeite waard is.`,category:"games",categoryLabel:"Games",author:"Lisa Jansen",date:"2026-02-08",image:"https://assets.nintendo.com/image/upload/q_auto/f_auto/c_fill,w_1200/ncom/en_US/articles/2025/nintendo-switch-2-to-be-released-in-2025/1920x1080_WN_PR01162025",views:18400,readTime:5},{id:7,slug:"dragon-quest-vii-reimagined-review",title:"Dragon Quest VII Reimagined review — een legendarische RPG voor een nieuwe generatie",excerpt:"Square Enix heeft een van de meest ambitieuze RPGs uit 2000 volledig herschreven. Betere graphics, een vernomen vocatie-systeem en een gestroomlijnd verhaal maken Dragon Quest VII Reimagined toegankelijker dan ooit. Maar verliest het daarmee ook zijn eigenzinnige charme?",content:`Dragon Quest VII: Fragments of the Forgotten Past was al in 2000 een anomalie: een RPG van 100+ uur op de PlayStation 1 met een trage beginopbouw, een complexe verhaalstructuur en een vocatie-systeem dat uren vergt om te begrijpen. Het was een gamers-game — voor liefhebbers van het genre, niet voor beginners. Reimagined probeert dat te veranderen zonder de kern van wat VII zo uniek maakt te verliezen.

**Wat is er veranderd?**

De meest zichtbare verbetering is visueel. Reimagined gebruikt de zogenaamde Diorama-engine die Square Enix introduceerde in Dragon Quest XII, en het resultaat is verbluffend: figuren en omgevingen zien eruit als bewegende miniatuurwereldjes in een kristallen bol. De stijl combineert de klassieke Akira Toriyama-esthetiek (inmiddels ge\xebrfd door zijn opvolgers) met moderne lichteffecten en architectonische details.
...
**Score: 8.5/10**`,category:"reviews",categoryLabel:"Reviews",author:"Nina Hoekstra",date:"2026-02-05",image:"https://cdn.akamai.steamstatic.com/steam/apps/2499860/header.jpg",views:12300,readTime:6,score:8.5},{id:8,slug:"nieuwe-xbox-hardware-2026-geruchten-specs",title:"Nieuwe Xbox hardware onderweg — wat weten we al over de volgende console?",excerpt:'Asha Sharma, de nieuwe CEO van Microsoft Gaming, beloofde in haar eerste grote interview dat er "snel significante hardware-aankondigingen" komen. Geruchten over een Xbox Series X-opvolger, een handheld en een vernieuwd Xbox Cloud-apparaat circuleren al maanden. Gameinside zet alles op een rij.',content:`De Xbox-scene is in beweging. Phil Spencer is weg, Asha Sharma is de nieuwe CEO en een van haar eerste publieke uitspraken was dat er "binnenkort hardware-nieuws" komt. Dat voelt als een directe reactie op de successen van de PlayStation 5 Pro en de Nintendo Switch 2 — en op de dalende Xbox-verkopen in Europa.
...
Minstens even interessant is het gerucht over een Xbox-handheld. Al tijdens zijn laatste jaar heeft Phil Spencer gezegd dat een draagbare Xbox "niet ver weg" is. Bronnen beschrijven een apparaat dat gelijkenissen vertoont met de Steam Deck, maar dieper ge\xefntegreerd is met Xbox Cloud Gaming en Game Pass. Theoretisch kun je hiermee elke Xbox-game spelen zonder dat ze lokaal ge\xefnstalleerd hoeven te zijn.
...
Wij hopen op een aankondiging in Q2 2026. Asha Sharma heeft gezegd: binnenkort. We houden haar aan die belofte.`,category:"tech",categoryLabel:"Tech",author:"Kevin de Groot",date:"2026-02-01",image:"https://xboxwire.thesourcemediaassets.com/sites/2/2026/01/012635_Base-Event-Post-Show_3840x2160_03-1ff4ad3f691eb6b547a2.jpg",views:16700,readTime:5},{id:9,slug:"clair-obscur-expedition-33-wint-9-game-awards",title:"Clair Obscur: Expedition 33 wint 9 Game Awards — meer dan Baldur's Gate 3 in 2023",excerpt:"Het kleine Franse studio Sandfall Interactive heeft de gaming-industrie opgeschud. Clair Obscur: Expedition 33 won negen prijzen op The Game Awards 2025, waaronder Game of the Year. Meer dan Baldur's Gate 3, meer dan elk AAA-spel in recent geheugen. Hoe is dit mogelijk?",content:`De avond van 12 december 2025 zal de gaming-industrie lang bijblijven. Clair Obscur: Expedition 33 — een debuutspel van een Frans studio met twaalf medewerkers — won negen van de zeventien prijzen op The Game Awards, waaronder Game of the Year, Best RPG, Best Narrative, Best Art Direction en Best Score & Music. Het versloeg Elden Ring: Nightreign, Call of Duty: Black Ops 7 en Nintendo's eigen Mario Kart World.

**Hoe heeft een klein studio de grote namen verslagen?**

Clair Obscur: Expedition 33 is in 2025 de definitie van lightning in a bottle. Het spel combineert turn-based combat met real-time parry-mechanica, een surrealistisch Frans kunstmilieu als setting en een verhaal dat zowel po\xebtisch als verpletterd persoonlijk aanvoelt. Recensenten noemden het "de Final Fantasy die Square Enix al tien jaar probeert te maken maar nooit lukt".
...
We hebben Clair Obscur: Expedition 33 uitgebreid gerecenseerd bij release en gaven het een 9.5. De Game Awards-overwinning voelt volledig verdiend. Als je dit nog niet hebt gespeeld: ga nu.`,category:"nieuws",categoryLabel:"Nieuws",author:"Nina Hoekstra",date:"2026-01-25",image:"https://cdn.akamai.steamstatic.com/steam/apps/1903340/header.jpg",views:31200,readTime:5},{id:10,slug:"ea-overgenomen-55-miljard-saoedisch-consortium",title:"EA overgenomen voor 55 miljard dollar — wat betekent dit voor FIFA, Sims en Battlefield?",excerpt:"Electronic Arts is overgenomen door een Saoedisch-Emirati consortium in de grootste gaming-overname ooit. 55 miljard dollar in contanten. De impact op EA Sports FC, The Sims, Battlefield en Mass Effect is onzeker. Gameinside is bezorgd — en dat leggen we hier precies uit.",content:`Op 18 januari 2026 maakte Electronic Arts via een persconferentie in San Francisco de overname bekend die de gaming-wereld al weken verwachtte maar hoopte dat niet zou plaatsvinden. Een consortium bestaande uit het Saoedische Public Investment Fund en het Abu Dhabi sovereign wealth fund MDI neemt EA over voor $55 miljard in cash. Het is de grootste leveraged buyout in de Wall Street-geschiedenis van entertainment.

**Hoe is het zover gekomen?**

EA's positie was al jaren kwetsbaar. Na de controversi\xeble loot-box-praktijken in FIFA Ultimate Team, de herhaalde teleurstellingen van Battlefield 2042 en de stagnerende Sims-franchise had EA's koers jaren stilgestaan. Het consortium, dat al belangen heeft in Newcastle United FC, Formula 1-teams en meerdere Europese gamestudio's, zag een kans.

CEO Andrew Wilson bleef aan in zijn functie — een bewuste keuze die analisten interpreteren als een poging om de overgang soepel te laten verlopen. Maar de werkelijke beslissingsmacht verschuift naar een raad van commissarissen die primair ge\xefnteresseerd is in return on investment, niet in creatieve vrijheid.
...
We zijn eerlijk: we zijn niet optimistisch. Soevereine vermogensfondsen investeren in media voor culturele invloed en financieel rendement — niet voor gamedesign-integriteit. De kans dat EA's games meer pay-to-win worden, meer gefocust op korte-termijn inkomsten en minder gericht op creatieve risico's, is re\xebel.

Voor Nederlandse gamers die FIFA en Sims al jaren spelen: jullie kunnen het beste blijven spelen wat jullie al hebben, en alternatieve studios in de gaten houden. Want dit scenario eindigt zelden goed voor de speler.`,category:"nieuws",categoryLabel:"Nieuws",author:"Sophie Bakker",date:"2026-01-18",image:"https://cdn.akamai.steamstatic.com/steam/apps/2669320/header.jpg",isBreaking:!0,views:24800,readTime:5},{id:11,slug:"ubisoft-tencent-deal-nieuw-gaming-filiaal",title:"Ubisoft en Tencent sluiten deal — maar wat verandert er echt voor fans?",excerpt:"Na jaren van tegenvallende verkopen en een dramatisch dalende beurskoers heeft Ubisoft een strategische deal gesloten met Tencent. Een gezamenlijk gaming-filiaal, meer nadruk op service-games en een beloofd nieuw Assassin's Creed-universum. Maar is dit redding of langzaam verdrinking?",content:`Ubisoft en Tencent zijn geen onbekenden. De Chinese techgigant had al een belang van 9,9% in de Franse gamepublisher. Maar de deal die op 12 januari 2026 werd aangekondigd gaat verder: een gezamenlijk filiaal dat specifiek wordt opgericht voor de ontwikkeling van nieuwe gaming-IP's en uitbreiding van bestaande franchises naar de Chinese en Aziatische markt.

**De context: Ubisoft in vrije val**

Om te begrijpen waarom Ubisoft dit heeft gedaan, moet je kijken naar de recente teleurstellingen. Skull and Bones na zes jaar ontwikkeling en een "AAAA-game"-belofte werd een commerci\xeble mislukking. Assassin's Creed: Shadows miste aanvankelijk zijn releasedatum en werd met gemixte reacties ontvangen. De aandelenkoers halveerde in twee jaar. Ubisoft stond voor een keuze: verkopen of herstructureren. Ze kozen voor herstructurering — met Tencent als partner.
...
We zijn sceptisch. Tencent's betrokkenheid bij Riot Games en andere westerse studio's heeft zelden geleid tot betere single-player ervaringen — eerder het tegenovergestelde. De kans dat Ubisoft met deze deal meer service-games gaat maken ten koste van verhaalgedreven single-player avonturen is groot. Maar: als de alternatief faillissement was, is dit de minst slechte optie.`,category:"nieuws",categoryLabel:"Nieuws",author:"Joost Vermeer",date:"2026-01-12",image:"https://cdn.akamai.steamstatic.com/steam/apps/3159330/header.jpg",views:19300,readTime:5},{id:12,slug:"hollow-knight-silksong-review-eindelijk-gespeeld",title:"Hollow Knight: Silksong review — 7 miljoen mensen kochten het blind. Ze kregen gelijk.",excerpt:'Na acht jaar wachten, ontelbare memes en de langstlopende "wanneer?" in gaming-geschiedenis is Hollow Knight: Silksong eindelijk uit. Wij speelden het volledig uit en kunnen zeggen: het was het wachten volledig waard. Dit is een meesterwerk.',content:`Er zijn games die je met verwachtingen speelt, en dan zijn er games waarbij de verwachtingen zo hoog zijn opgeblazen dat geen enkele realistische uitkomst ze kan waarmaken. Hollow Knight: Silksong hoort in de tweede categorie. En toch — somehow — slaagt Team Cherry erin om beide groepen tevreden te stellen.
...
**Score: 10/10**`,category:"reviews",categoryLabel:"Reviews",author:"Mark Visser",date:"2026-01-05",image:"https://cdn.akamai.steamstatic.com/steam/apps/1030300/header.jpg",views:44900,readTime:7,score:10},{id:13,slug:"gta-6-opnieuw-uitgesteld-19-november-2026",title:"GTA 6 opnieuw uitgesteld naar 19 november 2026 — en Rockstar ontsloeg vakbondswerkers",excerpt:"Grand Theft Auto VI gaat niet in 2025 uit. Rockstar heeft het spel opnieuw uitgesteld, nu naar november 2026. Tegelijkertijd ontsloeg het bedrijf 30 medewerkers die intern campagne voerden voor een vakbond. Gameinside vraagt zich af: wanneer is genoeg genoeg?",content:`Op 20 december 2025 brak het nieuws via Kotaku en later bevestigd door Rockstar zelf: Grand Theft Auto VI wordt wederom uitgesteld. Niet naar begin 2026, niet naar zomer 2026, maar naar 19 november 2026. Het is de tweede keer in twee jaar dat Rockstar een releasedatum mist. En de omstandigheden zijn deze keer bitter.
...
We willen GTA VI net zo graag als iedereen. Maar we willen het ook gemaakt door mensen die eerlijk behandeld worden. Rockstar heeft in 2026 de kans om te bewijzen dat de prachtige eindproduct hand in hand kan gaan met betere studio-praktijken. Ze hoeven dit alleen maar te kiezen.`,category:"nieuws",categoryLabel:"Nieuws",author:"Thomas van der Berg",date:"2025-12-20",image:"https://img.youtube.com/vi/VQRLujxTm3c/maxresdefault.jpg",isBreaking:!0,views:38600,readTime:5},{id:14,slug:"call-of-duty-black-ops-7-review-teleurstelling",title:"Call of Duty: Black Ops 7 review — de meest verwachte teleurstelling van het jaar",excerpt:"Na het succes van Battlefield 6 lag de lat hoog voor Activision. Black Ops 7 levert een degelijke campagne, maar de multiplayer is formuliek en de warzone-integratie voelt geforceerd. Was dit genoeg voor de grote concurrent? Gameinside oordeelt na 25 uur.",content:`Call of Duty heeft een reputatie om te leveren. Black Ops als sub-serie heeft de beste verhaalcampagnes in de franchise en een multiplayer die miljoenen spelers jarenlang bezighoudt. Black Ops 7 beloofde een stap voorwaarts — een nieuw verhaaluniversum, een volledige overhaul van de multiplayer en diepgaandere integratie met Warzone. Niet alles van dat plan is gelukt.
...
**De multiplayer: comfortabel maar onge\xefnspireerd**

Hier begint de teleurstelling. De multiplayer van Black Ops 7 voelt als een update van Black Ops 6 in plaats van een nieuwe richting. De nieuwe Kill Confirmed-variant en twee nieuwe Hardpoint-maps zijn leuk, maar onvoldoende om het gebrek aan frisse idee\xebn te verbloemen. Na Battlefield 6's grote herintroductie van destructible environments en playercount-experimenten voelt de BO7-multiplayer smal.
...
**Score: 6.5/10**`,category:"reviews",categoryLabel:"Reviews",author:"Kevin de Groot",date:"2025-12-15",image:"https://cdn.akamai.steamstatic.com/steam/apps/3606480/header.jpg",views:27100,readTime:6,score:6.5},{id:15,slug:"gameprijzen-door-het-dak-sony-microsoft-nintendo",title:"Gameprijzen door het dak: 80 dollar voor Mario Kart, en niemand stop het",excerpt:"Sony, Microsoft en Nintendo verhoogden allemaal hun game- en hardwareprijzen in 2025. Mario Kart World voor 80 dollar was de druppel die de emmer deed overlopen. November 2025 was de slechtste verkoopmaand voor games since 1995. Gameinside rekent af met de industrie.",content:`Er was een tijd dat een nieuwe game €59,99 kostte en dat als veel werd beschouwd. Die tijd is voorbij. In 2025 bereikten gameprijzen nieuwe hoogtepunten die spelers, critics en zelfs aandeelhouders verontruste. Nintendo zette de toon met Mario Kart World voor $79,99 bij de Switch 2-launch. Sony volgde met $74,99 voor exclusives op de PS5 Pro. Microsoft stelde de Xbox-exclusiveprijs bij naar €69,99 voor first-party titels.
...
We zijn van mening dat de industrie een strategische fout maakt. Korte-termijn hogere inkomsten per verkocht exemplaar gaan ten koste van de breedte van het publiek op lange termijn. Game Pass, PlayStation Plus en Nintendo Switch Online zijn de juiste richting — niet hogere stukprijzen. De sector heeft zichzelf in de voet geschoten. En het is de speler die de kogel heeft opgevangen.`,category:"nieuws",categoryLabel:"Nieuws",author:"Sophie Bakker",date:"2025-12-10",image:"https://img.youtube.com/vi/VrTVeYm4iIM/maxresdefault.jpg",views:22500,readTime:5},{id:16,slug:"ai-games-debat-larian-indie-ontwikkelaars",title:"AI in games: het grote debat van 2025 — wie heeft er gelijk?",excerpt:"Larian Studios-baas Swen Vincke is positief over AI-tools voor ontwikkelaars. Indie-ontwikkelaars zijn in opstand. Vakbonden waarschuwen voor baanverlies. Gameinside neemt stelling in een debat dat de toekomst van game-ontwikkeling bepaalt.",content:`Swen Vincke, de oprichter van Larian Studios — de makers van Baldur's Gate 3 — deed in december 2025 een statement dat de industrie in twee kampen splitste: "AI-tools voor animatie, textures en NPC-dialogen hebben ons duizenden werkuren bespaard. Zonder die tools was BG3 niet wat het geworden is." Twee dagen later verscheen een open brief ondertekend door 1.200 indie-ontwikkelaars die Vincke's uitspraken "gevaarlijk na\xefef" noemden.

**Vincke's punt: effici\xebntie, niet vervanging**
...
AI is niet per definitie kwaad voor games. Tools die ontwikkelaars helpen effici\xebnter te werken zonder banen te elimineren zijn welkom. Maar de lijn is dun, en de incentive van grote bedrijven is niet de lijn in stand te houden. Vincke heeft gelijk dat AI hem hielp BG3 te maken. De industrie heeft gelijk dat dit een gevaarlijk precedent schept als het zonder kaders wordt overgenomen. Die kaders ontbreken momenteel. Dat is het echte probleem.`,category:"nieuws",categoryLabel:"Nieuws",author:"Nina Hoekstra",date:"2025-12-01",image:"https://cdn.akamai.steamstatic.com/steam/apps/1086940/header.jpg",views:18200,readTime:5},{id:17,slug:"arc-raiders-review-verrassende-hit-2025",title:"Arc Raiders review — de meest verrassende hit van 2025 die niemand zag aankomen",excerpt:"Embark Studios — de makers van The Finals — brachten in oktober 2025 Arc Raiders uit en bijna niemand sprak erover. Tot de mond-tot-mondreclame begon. Bijna 8 miljoen exemplaren in zes weken. Gameinside speelde 30 uur en vertelt je waarom dit spel werkt.",content:`Arc Raiders werd niet verwacht om de hit van het jaar te worden. Embark Studios, de Zweedse developer achter het populaire The Finals, had Arc Raiders al jaren in ontwikkeling, maar door marketingproblemen en een uitgestelde release was het spel onder de radar gebleven. Tot 30 oktober 2025.
...
**Score: 8.5/10**`,category:"reviews",categoryLabel:"Reviews",author:"Joost Vermeer",date:"2025-11-20",image:"https://cdn.akamai.steamstatic.com/steam/apps/1808500/header.jpg",views:15900,readTime:6,score:8.5},{id:18,slug:"nintendo-switch-2-snelst-verkochte-console-ooit",title:"Nintendo Switch 2: 10,36 miljoen stuks in vier maanden — de snelst verkochte console ooit",excerpt:"Nintendo heeft de verkoopcijfers bekendgemaakt: 10,36 miljoen Switch 2-consoles in vier maanden. Sneller dan elke console voor hem. Is de upgrade de moeite waard voor Nederlandse gamers die nog een originele Switch hebben? Gameinside geeft een eerlijk advies.",content:`Nintendo heeft zijn meest recente kwartaalrapport bekendgemaakt en de Nintendo Switch 2-cijfers zijn indrukwekkend: 10,36 miljoen verkochte exemplaren in vier maanden. Ter vergelijking: de originele Nintendo Switch bereikte zijn eerste 10 miljoen pas in negen maanden. De Wii had er twaalf maanden voor nodig. De Nintendo Switch 2 is, statistisch gezien, de snelst verkochte console in de consumentenelectronicageschiedenis.
...
Dit is de vraag die we het meest horen. Ons eerlijke antwoord: het hangt af van hoe je speelt. Als je voornamelijk in tv-modus speelt en je huidige Switch goed functioneert, is er geen urgentie. De verbetering in grafische kwaliteit in tv-modus is merkbaar maar niet generationeel. Als je voornamelijk in handheld-modus speelt: de Switch 2 heeft een 7,9-inch OLED-scherm (tegenover 6,2 inch bij de OLED-Switch) en een aanzienlijk langere batterijduur. Die upgrade voelt w\xe9l generationeel.

**De Dutch gaming community over de Switch 2**

In onze enqu\xeate onder 2.400 Nederlandse gamers geeft 68% aan "tevreden tot zeer tevreden" te zijn met de Switch 2. De belangrijkste kritiekpunten: de €80 launch-prijs voor Mario Kart World en de beperkte beschikbaarheid van consoles in de eerste zes weken na launch.

**Gameinside's advies**

Koop de Switch 2 als je nu een eerste Switch aanschaft of als je in handheld-modus speelt. Wacht als je tevreden bent met je huidige setup — de Switch 1 wordt nog jarenlang ondersteund.`,category:"nieuws",categoryLabel:"Nieuws",author:"Lisa Jansen",date:"2025-11-15",image:"https://img.youtube.com/vi/itpcsQQvgAQ/maxresdefault.jpg",views:21400,readTime:5},{id:19,slug:"battlefield-6-review-comeback-die-iedereen-nodig-had",title:"Battlefield 6 review — de comeback die de hele genre-scene nodig had",excerpt:"Na Battlefield 2042's rampzalige launch was de verwachting laag. Battlefield 6 is echter precies wat de franchise en het genre nodig had: grootschalige chaos, destructible environments en een campagne die je meeneemt. Gameinside speelt 40 uur en geeft zijn volledige oordeel.",content:`Het is moeilijk te overdrijven hoe diep Battlefield 2042 de franchise had beschadigd. Slechte launch, lege servers, verwijderde features, maandenlange patches. EA en DICE moesten meer dan het gebroken vertrouwen repareren — ze moesten de reden heruitvinden waarom mensen \xfcberhaupt Battlefield speelden. Met Battlefield 6 hebben ze dat gedaan.
...
**Score: 8.5/10**`,category:"reviews",categoryLabel:"Reviews",author:"Kevin de Groot",date:"2025-10-10",image:"https://cdn.akamai.steamstatic.com/steam/apps/2807960/header.jpg",views:33700,readTime:7,score:8.5},{id:20,slug:"little-nightmares-3-review-co-op-horror",title:"Little Nightmares 3 review — voor het eerst co-op, en het werkt verbluffend goed",excerpt:"Bandai Namco neemt de Little Nightmares-franchise een stap verder met de eerste co-op-modus in de serie. Low en Alone als nieuwe kinderkarakter in een wereld die nog donkerder en surrealer is dan zijn voorgangers. Werkt co-op-horror? Gameinside test het volledig uit.",content:`Little Nightmares is een serie die gebouwd is op eenzaamheid. De eerste twee games lieten je alleen, kwetsbaar en klein in een wereld van gigantische, groteske volwassenen. Die eenzaamheid was zowel thematisch als gameplay-essentieel. Little Nightmares 3 doet iets dat aanvoelde als onmogelijk: het voegt een tweede speler toe en verliest niets van de horror.

**Low en Alone: twee stemmen, \xe9\xe9n verhaal**
...
De meest briljante co-op-momenten zijn die waarbij \xe9\xe9n speler gedwongen is te kijken terwijl de ander een angstaanjagend segment doorloopt. Je kunt helpen noch ingrijpen — alleen toekijken. Die machteloosheid werkt verplettend goed.
...
**Score: 8/10**`,category:"reviews",categoryLabel:"Reviews",author:"Nina Hoekstra",date:"2025-10-05",image:"https://cdn.akamai.steamstatic.com/steam/apps/1392860/header.jpg",views:14200,readTime:6,score:8}],i=t.find(e=>e.isFeatured)??t[0],r=e=>t.find(n=>n.slug===e),o=e=>t.filter(n=>n.category===e),s=()=>[...t].sort((e,n)=>n.views-e.views).slice(0,5),d=(e,n=3)=>t.filter(n=>n.id!==e.id&&n.category===e.category).slice(0,n),l={nieuws:"Nieuws",reviews:"Reviews",games:"Games",tech:"Tech",hardware:"Hardware",video:"Video"},g={nieuws:"bg-cyan-500",reviews:"bg-purple-600",games:"bg-blue-500",tech:"bg-emerald-500",hardware:"bg-amber-500",video:"bg-red-500"},m={nieuws:"text-cyan-400",reviews:"text-purple-400",games:"text-blue-400",tech:"text-emerald-400",hardware:"text-amber-400",video:"text-red-400"}}};